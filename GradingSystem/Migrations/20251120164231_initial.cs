        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prelim = table.Column<double>(type: "double", nullable: true),
                    Midterm = table.Column<double>(type: "double", nullable: true),
                    SemiFinal = table.Column<double>(type: "double", nullable: true),
                    Final = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSubjectAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSubjectAssignments_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSubjectAssignments_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectAssignments_StudentId",
                table: "StudentSubjectAssignments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectAssignments_SubjectId",
                table: "StudentSubjectAssignments",
                column: "SubjectId");
